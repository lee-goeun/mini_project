...
public class MemberControllerImpl implements MemberController{
	...
	//getViewName없이 구현해보기
	/*
	 * @RequestMapping(value="/member/*Form.do", method=RequestMethod.GET) public
	 * ModelAndView form(@RequestParam(value="result", required=false) String
	 * result,
	 * 
	 * @RequestParam(value="action", required=false) String action,
	 * HttpServletRequest request, HttpServletResponse response) throws Exception{
	 * String viewName = (String)request.getAttribute("viewName"); HttpSession
	 * session = request.getSession(); session.setAttribute("action", action);
	 * ModelAndView mav = new ModelAndView(); mav.addObject("result", result);
	 * mav.setViewName(viewName); return mav; }
	 */
	
	@RequestMapping(value = {"/member/memberForm.do", "/member/loginForm.do"}, method=RequestMethod.GET)
